...
<body class="bg-dark">
	<div class="jumbotron text-center">
		...
		<a class="btn btn-danger" href="indexloan.php" >Loan Calculator</a>  
		<a class="btn btn-danger" href="indexbmi.php" >BMI Calculator</a>  
		<a class="btn btn-danger" href="indexelectricity.php" >Electricity Calculator</a>
	</div>
